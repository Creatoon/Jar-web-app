...
var createRoomBox = document.querySelector('.createRoom__box'); // Universal user id
...
if (roomCreateForm) {
  ...
  roomCreateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var name, description, password, photo, form;
